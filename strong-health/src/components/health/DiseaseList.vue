<template>
	<div class="diseaselist">
		<div class="newestArticleList main-box-nick" v-for="n in desases" @click="todetails(n.articleId)">
			...
			getdesases(val){
				...
				.then((res)=>{
					if(res.data.resultCode == "1"){
						this.desases = res.data.resultObj.articlList;
					}
				})
			}
		},
